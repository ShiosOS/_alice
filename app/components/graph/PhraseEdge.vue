...
<template>
  ...
  <EdgeLabelRenderer>
    <div
      class="nodrag nopan pointer-events-none absolute origin-center rounded bg-background/85 px-1.5 py-0.5 font-display text-[11px] italic tracking-wide text-primary"
      :style="{
